...
var BrowserPrint = function () {
    ...
    var e = {}, k = {}, p = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
    navigator.userAgent.indexOf("Trident/7.0");
    var l = "https://localhost:9101/";
    e.Device = function (a) {
        var m = this;
        this.name = a.name;
        ...
        this.readUntilStringReceived = function (d, a, b, e, c) {
            ...
            a = function (a, b, e, f, g) {
                return function (c) {
                    if (c && 0 !== c.length) f = 0; else if (0 >= f) {
                        b(g);
                        return
                    }
                    c = g + c;
    ...
    e.getLocalDevices =
        function (a, c, d) {
            ...
            g && (finishedFunction = function (b) {
                ...
                for (var c in response) if (response.hasOwnProperty(c) && response[c].constructor === Array) for (arr = response[c], b = 0; b < arr.length; ++b) arr[b] = new e.Device(arr[b]);
