...
function VoorspellingsgrafiekenDeelnamekans() {
    ...
    svgDiv.setAttribute('onmousemove', 'deVoorspellingsgrafiekenDeelnamekans.mouseMove(event)');
    svgDiv.setAttribute('onmousedown', 'deVoorspellingsgrafiekenDeelnamekans.mouseDown(event)');
    svgDiv.setAttribute('onmouseup', 'deVoorspellingsgrafiekenDeelnamekans.mouseUp(event)');
    ...
    leesDeelnamekansen(function() {
        ...
        grafiekVervolgRonde.init(alleDeelnamekansen.kolommen.find(function(kolom) {return kolom.naam === 'Vervolgronde';}).cumulatieveDeelnamekansVerdeling);
        grafiekEersteRonde.init(alleDeelnamekansen.kolommen.find(function(kolom) {return kolom.naam === 'Eerste ronde';}).cumulatieveDeelnamekansVerdeling);

        svg.setAttribute('height', legendaOnderkant);
    });
    ...
    function createLegendaLijn(color, lijndikte, text, tekstbreedte) {
        ...
        if (color != null) {
            ...
            result.setAttribute('style', 'stroke:' + color + '; stroke-width: ' + lijndikte + 'px;');
    ...
    function Voorspellingsgrafiek(vervolgRondeOfEersteRonde, left, naam) {
        ...
        this.init = function(cdv) {
            ...
            var text = createText(x, y, 'Gemiddeld ' + gemiddeldeDeelnamekans() + '%', 'text-anchor: middle').
                setAttribute('transform', 'rotate(270 ' + x + ', ' + y + ')');
        ...
        function createDeelnamekanslijn() {
            ...
            result.setAttribute('style', 'fill:none; stroke:' + deelnamekanslijnColor + '; stroke-width:' + deelnamekanslijndikte);
            svg.appendChild(result);
            return result;
        }
        ...
        function createOnzekerheidslijn() {
            ...
            result.setAttribute('style', 'fill:none; stroke:' + onzekerheidslijnColor + '; stroke-width:' + onzekerheidslijndikte);
            svg.appendChild(result);
            return result;
        }
        ...
        function createOnzekerheidsvlak() {
            ...
            result.setAttribute('style', 'fill:' + onzekerheidsvlakColor + '; stroke:none ; stroke-width:2');
            svg.appendChild(result);
            return result;
        }
    ...
    function createText(x, y, text, style) {
        ...
        result.setAttribute('style', 'font-family: Arial; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; ' + style);
...
var deVoorspellingsgrafiekenDeelnamekans = new VoorspellingsgrafiekenDeelnamekans();
