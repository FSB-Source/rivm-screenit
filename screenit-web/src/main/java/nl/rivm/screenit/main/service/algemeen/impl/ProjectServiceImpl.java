...
public class ProjectServiceImpl implements ProjectService
{
	...
	{
		return projectRepository.existsByEindDatumAfterAndProjectBriefActiesVragenlijstId(currentDateSupplier.getDate(), vragenlijstId);
	}

	@Override
	public boolean isVragenlijstGekoppeldAanProject(Long vragenlijstId)
	{
		return projectBriefActieRepository.existsByVragenlijstId(vragenlijstId);
	}
