...
public interface MammaFotobesprekingService
{
	List<MammaFotobespreking> zoekFotobesprekingen(MammaFotobesprekingWerklijstZoekObject zoekObject, long first, long count, Sort sort);

	long countFotobesprekingen(MammaFotobesprekingWerklijstZoekObject zoekObject);

	List<MammaFotobesprekingOnderzoek> zoekFotobesprekingOnderzoeken(MammaFotobesprekingOnderzoekenWerklijstZoekObject zoekObject, long first, long count, Sort sort);

	long countFotobesprekingOnderzoeken(MammaFotobesprekingOnderzoekenWerklijstZoekObject zoekObject);

	long getAantalBesproken(MammaFotobespreking fotobespreking);
