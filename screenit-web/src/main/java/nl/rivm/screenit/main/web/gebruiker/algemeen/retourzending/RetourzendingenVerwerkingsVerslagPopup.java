...
public class RetourzendingenVerwerkingsVerslagPopup extends GenericPanel<RetourzendingLogEvent>
{

	private static final long serialVersionUID = 1L;

	public RetourzendingenVerwerkingsVerslagPopup(String id, IModel<RetourzendingLogEvent> model)
	{
		super(id, model);
