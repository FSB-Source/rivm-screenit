...
public class TestCervixLabformulierGescandPopup extends TestCervixUitnodigingenLaboratoriaPopup
{

	private static final long serialVersionUID = 1L;

	public TestCervixLabformulierGescandPopup(String id, IModel<List<Client>> clientModel)
	{
	...
	{
		return testTimelineService.magLabformulierGescand(uitnodiging);
	}
