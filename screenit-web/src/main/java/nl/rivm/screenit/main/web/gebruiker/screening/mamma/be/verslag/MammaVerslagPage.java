...
public class MammaVerslagPage extends AbstractMammaBeoordelenPage
{
	@SpringBean
	private MammaImsService imsService;

	private MammaVerslagRondePanel huidigeRondePanel;

	public MammaVerslagPage(Long initieleBeoordelingId, List<Long> beoordelingenIds,
		Class<? extends AbstractMammaBeWerklijstPage> werklijstPageClass)
	{
	...
	protected void maakRondesContainer(IModel<MammaBeoordeling> beoordelingModel)
	{
		...
		huidigeRondePanel = new MammaVerslagRondePanel("rondeItem", beoordelingModel);
	...
	{
		return MammaBeLezerSoort.VERSLAG_MAKER;
	}
