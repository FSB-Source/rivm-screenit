...
public class MammaCeWerklijstZoekObject extends MammaBaseWerklijstZoekObject
{
	private IModel<List<BeoordelingsEenheid>> beoordelingsEenheden;

	private IModel<List<CentraleEenheid>> centraleEenheden;

	private Boolean metBriefOproepOnderbrokenOnderzoek = null;
	...
	public Boolean getMetBriefOproepOnderbrokenOnderzoek()
	{
		return metBriefOproepOnderbrokenOnderzoek;
	}

	public void setMetBriefOproepOnderbrokenOnderzoek(Boolean metBriefOproepOnderbrokenOnderzoek)
	{
		this.metBriefOproepOnderbrokenOnderzoek = metBriefOproepOnderbrokenOnderzoek;
	}
