...
{
	ColonRoosterBeperkingenDto getRoosterBeperkingen();

	void updateRoosterBeperkingen(ColonRoosterBeperkingenDto roosterBeperkingenDto) throws ValidatieException;
}
