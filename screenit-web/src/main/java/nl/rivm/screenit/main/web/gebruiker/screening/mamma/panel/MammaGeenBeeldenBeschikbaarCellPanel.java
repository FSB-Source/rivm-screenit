...
public abstract class MammaGeenBeeldenBeschikbaarCellPanel extends Panel
{

	@SpringBean
	private LogService logService;

	public MammaGeenBeeldenBeschikbaarCellPanel(String id, BootstrapDialog bootstrapDialog, String resourceKey, IModel<MammaUploadBeeldenVerzoek> uploadBeeldenVerzoekModel)
	{
		...
		add(new ConfirmingIndicatingAjaxLink<Void>("geenBeeldenBeschikbaar", bootstrapDialog, resourceKey)
		{
			...
			{
				onOpslaan(ajaxRequestTarget, (MammaUploadBeeldenVerzoek) MammaGeenBeeldenBeschikbaarCellPanel.this.getDefaultModelObject());
			}
		});
	}
