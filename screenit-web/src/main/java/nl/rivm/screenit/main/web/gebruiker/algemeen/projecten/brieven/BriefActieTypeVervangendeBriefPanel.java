...
public class BriefActieTypeVervangendeBriefPanel extends GenericPanel<ProjectBriefActie>
{

	private static final long serialVersionUID = 1L;

	public BriefActieTypeVervangendeBriefPanel(String id, IModel<ProjectBriefActie> model)
	{
		super(id, model);
