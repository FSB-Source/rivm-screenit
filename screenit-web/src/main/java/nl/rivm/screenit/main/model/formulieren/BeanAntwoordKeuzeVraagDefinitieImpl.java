...
@Entity
public class BeanAntwoordKeuzeVraagDefinitieImpl<T> extends BeanAntwoordVraagDefinitieImpl<T> implements AntwoordKeuzeVraagDefinitie<T>
{
	...
	public void setMeervoudig(boolean meervoudig)
	{
		this.meervoudig = meervoudig;
	}
}
