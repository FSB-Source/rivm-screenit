...
public class MammaArbitragePage extends AbstractMammaBeoordelenPage
{
	...
	public MammaArbitragePage(Long initieleBeoordelingId, List<Long> beoordelingenIds, Class<? extends AbstractMammaBeWerklijstPage> werklijstPageClass)
	{
	...
	{
		return MammaBeLezerSoort.ARBITRAGE_LEZER;
	}
	...
	protected void handleImsError(AjaxRequestTarget target, String errorMessage, Long onderzoekId)
	{
		...
		huidigeRondePanel.blokkeerOpslaan(target);
	}
