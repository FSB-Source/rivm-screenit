...
public class MassaLaesiePanel extends LaesiePanel
{
	public MassaLaesiePanel(String id, IModel<LaesieDto> model, List<LaesieDto> alleLaesies)
	{
	...
	protected void onInitialize()
	{
		...
		add(createSpecificatieRadioChoice("massaVorm", MammaMassaVorm.class));
		add(createSpecificatieRadioChoice("massaBegrenzing", MammaMassaBegrenzing.class));
		add(createSpecificatieRadioChoice("massaDensiteit", MammaMassaDensiteit.class));
	}
}
