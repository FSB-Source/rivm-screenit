...
public class TestMammaNieuweRondeMetOpenUitnodigingAction extends TestMammaVervolgKeuzeAction
{
	public TestMammaNieuweRondeMetOpenUitnodigingAction(List<Client> clienten, MammaTestTimelineService testTimelineService, MammaBaseTestTimelineService baseTestTimelineService,
