...
public class TestMammaDeelnamewensAction extends TestMammaVervolgKeuzeAction
{
	public TestMammaDeelnamewensAction(List<Client> clienten, MammaTestTimelineService testTimelineService, MammaBaseTestTimelineService baseTestTimelineService,
