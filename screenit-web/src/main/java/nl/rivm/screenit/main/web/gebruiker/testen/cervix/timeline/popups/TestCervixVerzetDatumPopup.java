...
public class TestCervixVerzetDatumPopup extends TestAbstractVerzetDatumPopup
{
	...
	public TestCervixVerzetDatumPopup(String id, IModel<List<Client>> clientModel)
	{
