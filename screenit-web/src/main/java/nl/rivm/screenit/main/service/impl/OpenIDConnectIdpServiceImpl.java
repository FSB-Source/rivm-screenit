...
@Configuration
public class OpenIDConnectIdpServiceImpl implements OpenIDConnectIdpService
{
	private static final Logger LOG = LoggerFactory.getLogger(OpenIDConnectIdpServiceImpl.class);
	...
	private String getIdpKeystoreLocation()
	{
		...
		{
			keystoreLocation = locatieFilestore + File.separator + "keystore" + File.separator + "keycloak-screenit-webfocus-local.jks";
		}
		else
		{
			keystoreLocation = locatieFilestore + File.separator + keystoreLocation;
		}
