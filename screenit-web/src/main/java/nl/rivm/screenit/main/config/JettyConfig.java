...
{
	private final RedisSessionDataStoreFactory redisSessionDataStoreFactory;

	@Override
	public void customize(JettyServletWebServerFactory factory)
	{
		factory.addServerCustomizers(server -> server.addBean(redisSessionDataStoreFactory));
	}
}
