...
public class CervixOverigeDashboardActiePage extends ClientBasePage
{

	private static final long serialVersionUID = 1L;

	private static final Logger LOGGER = LoggerFactory.getLogger(CervixOverigeDashboardActiePage.class);
	...
	public <T extends AbstractClientContactActiePanel<ClientContactActie>> CervixOverigeDashboardActiePage(IModel<Client> model, Class<T> contentClass,
		...
		final ClientContactActieType actieType, List<Object> extraPanelParams)
	{
		...
		Link<Void> annuleren = new Link<Void>("annuleren")
		{
			...
			public void onClick()
			{
				setResponsePage(ClientCervixDashboardPage.class);
			}
		...
		IndicatingAjaxSubmitLink opslaan = new IndicatingAjaxSubmitLink("opslaan", form)
		{
			...
			private <T extends AbstractClientContactActiePanel<ClientContactActie>> void contactAfronden(final ClientContactActieType actieType, T contentPanelConcreet)
			{
				...
				case CERVIX_AFMELDEN:
					CervixAfmelding afmelding = (CervixAfmelding) opslaanObjecten.get(ExtraOpslaanKey.AFMELDING);
				...
				case CERVIX_ZAS_AANVRAGEN:
					label = "success.zas_aanvragen";
					break;
				case CERVIX_HERDRUK:
					label = "success.herdruk_aanvragen";
					break;
				case CERVIX_UITSTEL:
					label = "success.uitstel_aanvragen";
					break;
				default:
					break;
				}
		...
		opslaan.add(new Label("opslaanTekst", new IModel<Object>()
		{
			...
			public Object getObject()
			{
				...
				case CERVIX_HERAANMELDEN:
					...
					break;
				case CERVIX_ZAS_AANVRAGEN:
					label = "label.button.zas_aanvragen";
					break;
				case CERVIX_HERDRUK:
					label = "label.button.herdruk_aanvragen";
					break;
				case CERVIX_UITSTEL:
					label = "label.button.uitstel_aanvragen";
					break;
				default:
					break;
				}
	...
	public IModel<String> getPageName()
	{
		...
		case CERVIX_HERAANMELDEN:
			...
			break;
		case CERVIX_ZAS_AANVRAGEN:
			label = getString("label.zas_aanvragen");
			break;
		case CERVIX_HERDRUK:
			label = getString("label.herdruk_aanvragen");
			break;
		case CERVIX_UITSTEL:
			label = getString("label.uitstel_aanvragen");
			break;
		case BEZWAAR:
