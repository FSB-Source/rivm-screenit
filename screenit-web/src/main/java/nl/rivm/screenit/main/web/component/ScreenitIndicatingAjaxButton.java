...
public class ScreenitIndicatingAjaxButton extends IndicatingAjaxButton
{
	public ScreenitIndicatingAjaxButton(String id)
	{
		super(id);
	}

	public ScreenitIndicatingAjaxButton(String id, Form<?> form)
	{
		super(id, form);
	}
