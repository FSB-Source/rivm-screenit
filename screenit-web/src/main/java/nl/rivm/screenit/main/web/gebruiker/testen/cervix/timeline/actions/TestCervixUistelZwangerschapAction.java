...
public class TestCervixUistelZwangerschapAction extends TestCervixVervolgKeuzeAction
{
	public TestCervixUistelZwangerschapAction(List<Client> clienten, CervixTestTimelineService cervixTestTimelineService,
