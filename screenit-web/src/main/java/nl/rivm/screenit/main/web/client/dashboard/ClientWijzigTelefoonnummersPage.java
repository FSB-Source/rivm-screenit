...
public class ClientWijzigTelefoonnummersPage extends ClientBasePage
{
	...
	public ClientWijzigTelefoonnummersPage(IModel<Client> client, ClientHoofdMenuitem menu)
	{
		this.menu = menu;
		add(new ClientWijzigTelefoonnummersPanel("panel", client, menu));
	}
	...
	{
		return new SimpleStringResourceModel("label.contactgegevenswijzigen");
	}
