...
@SecurityConstraint(
	...
	bevolkingsonderzoekScopes = {
		Bevolkingsonderzoek.COLON, Bevolkingsonderzoek.MAMMA, Bevolkingsonderzoek.CERVIX })
public class WachtwoordConfiguratiePage extends ParameterisatieBasePage
{
	...
	{
		var parameteriastie = parameterisatieService.loadParameterisatie();
		add(new WachtwoordConfiguratiePanel("landelijkeParameters", new Model<>(parameteriastie)));
	}
}
