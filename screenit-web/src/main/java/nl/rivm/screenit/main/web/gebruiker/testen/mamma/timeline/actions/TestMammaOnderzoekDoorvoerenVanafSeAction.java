...
public class TestMammaOnderzoekDoorvoerenVanafSeAction extends TestMammaVervolgKeuzeAction
{

	public TestMammaOnderzoekDoorvoerenVanafSeAction(List<Client> clienten, MammaTestTimelineService testTimelineService, MammaBaseTestTimelineService baseTestTimelineService,
	...
	public void execute()
	{
		for (Client client : clienten)
		{
			...
			mammaTestTimelineService.doorvoerenOnderzoek(afspraak);
		}
	}
}
