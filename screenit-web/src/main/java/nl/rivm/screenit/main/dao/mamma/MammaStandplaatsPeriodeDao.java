...
public interface MammaStandplaatsPeriodeDao
{
	List<MammaStandplaatsPeriode> getStandplaatsPeriodesVoorBulkVerzetten(ScreeningOrganisatie regio, Date verzettenVanaf);
