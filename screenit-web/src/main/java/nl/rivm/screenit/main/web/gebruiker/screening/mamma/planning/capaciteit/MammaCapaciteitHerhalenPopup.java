...
public abstract class MammaCapaciteitHerhalenPopup extends GenericPanel<MammaScreeningsEenheid>
{
	...
	public MammaCapaciteitHerhalenPopup(String id, IModel<MammaScreeningsEenheid> screeningEenheid, LocalDate herhalingsWeek)
	{
		...
		ConfirmingIndicatingAjaxSubmitLink<Void> opslaan = new ConfirmingIndicatingAjaxSubmitLink<Void>("opslaan", herhalenForm, confirmPopup, "overschrijven.popup")
		{
			...
			protected void onSubmit(AjaxRequestTarget target)
			{
				...
				baseConceptPlanningsApplicatie.herhaalWeek(MammaCapaciteitHerhalenPopup.this.getModelObject(), selectedSe, herhalingsWeek, herhalenVanafWeek, herhalenTotEnMetWeek,
					ScreenitSession.get().getLoggedInInstellingGebruiker());
				MammaScreeningsEenheid origSe = MammaCapaciteitHerhalenPopup.this.getModelObject();
