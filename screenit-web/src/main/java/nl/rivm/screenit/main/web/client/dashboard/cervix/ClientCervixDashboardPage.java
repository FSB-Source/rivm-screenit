...
public class ClientCervixDashboardPage extends ClientBasePage
{
	...
	public ClientCervixDashboardPage()
	{
		Boolean toonVervangendeTekst = preferenceService.getBoolean(PreferenceKey.CERVIX_CLIENTPORTAAL_TOON_VERVANGENDE_TEKST.name(), Boolean.FALSE);
		if (Boolean.TRUE.equals(toonVervangendeTekst))
		{
			throw new RestartResponseException(ClientCervixDashboardVervangendeTekstPage.class);
		}
		...
		add(new CervixOverigeDashboardActiesPanel("overige", client));
	}
