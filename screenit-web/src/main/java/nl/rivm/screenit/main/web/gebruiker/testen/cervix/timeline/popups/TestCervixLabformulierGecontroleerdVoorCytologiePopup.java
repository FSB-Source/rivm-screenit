...
public class TestCervixLabformulierGecontroleerdVoorCytologiePopup extends TestCervixUitnodigingenPopup
{

	private static final long serialVersionUID = 1L;

	public TestCervixLabformulierGecontroleerdVoorCytologiePopup(String id, IModel<List<Client>> clientModel)
	{
	...
	{
		return testTimelineService.magLabformulierGecontroleerdVoorCytologie(uitnodiging);
	}
