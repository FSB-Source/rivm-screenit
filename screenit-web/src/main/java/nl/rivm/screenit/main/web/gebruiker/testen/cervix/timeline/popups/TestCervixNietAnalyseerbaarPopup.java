...
public class TestCervixNietAnalyseerbaarPopup extends TestCervixUitnodigingenPopup
{

	private static final long serialVersionUID = 1L;

	public TestCervixNietAnalyseerbaarPopup(String id, IModel<List<Client>> clientModel)
	{
	...
	{
		return testTimelineService.magNietAnalyseerbaar(uitnodiging);
	}
