...
public interface RolService
{
	...
	boolean opslaan(Rol rol, List<InstellingGebruikerRol> rollen, List<Bevolkingsonderzoek> verwijderdeBevolkingsonderzoek, InstellingGebruiker instellingGebruiker);
