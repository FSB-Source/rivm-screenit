...
public class TestCervixAanvraagPopup extends TestCervixUitnodigingenLaboratoriaPopup
{
	public TestCervixAanvraagPopup(String id, IModel<List<Client>> clientModel)
	{
	...
	{
		return testTimelineService.magAanvraag(uitnodiging);
	}
