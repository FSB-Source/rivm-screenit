package nl.rivm.screenit.main.web.gebruiker.algemeen.batch.parameterpopuppanel.mammapalgaexport;
...
public class BatchMammaPalgaExportParameterPopupPanel extends GenericPanel<MammaPalgaExportConfig> implements IBatchParameterPopupPanel
{
	...
	public BatchMammaPalgaExportParameterPopupPanel(String id, Form<?> form)
	{
		...
		ComponentHelper.addRadioChoice(this, "gewensteUitslag", MammaPalgaExportGewensteUitslag.class);
	...
	public void vulJobParameters(Map<String, Object> jobParameters)
	{
		try
		{
			jobParameters.put(JobStartParameter.MAMMA_PALGA_EXPORT.name(), objectMapper.writeValueAsString(getDefaultModelObject()));
		}
