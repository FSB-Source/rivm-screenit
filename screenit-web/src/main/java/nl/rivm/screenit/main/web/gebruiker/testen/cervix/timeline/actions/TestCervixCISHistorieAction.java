...
public class TestCervixCISHistorieAction extends TestCervixVervolgKeuzeAction
{
	public TestCervixCISHistorieAction(List<Client> clienten, CervixTestTimelineService cervixTestTimelineService, CervixBaseTestTimelineService cervixBaseTestTimelineService)
	{
	...
	public void execute()
	{
		...
		{
			cervixBaseTestTimelineService.nieuweCISHistorie(client);
		}
	}
}
