...
public class ClientColonDashboardVervangendeTekstPage extends ClientBaseDashboardVervangendeTekstPage
{
	private static final long serialVersionUID = 1L;

	public ClientColonDashboardVervangendeTekstPage()
	{
		super(Bevolkingsonderzoek.COLON);
	}
