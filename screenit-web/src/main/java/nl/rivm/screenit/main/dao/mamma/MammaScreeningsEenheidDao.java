...
public interface MammaScreeningsEenheidDao
{
	...
	List<MammaScreeningsEenheid> zoekScreeningsEenheden(MammaScreeningsEenheid screeningsEenheid, ScreeningOrganisatie regio, int first, int count, String sortProperty,
		boolean asc);
	...
	List<MammaScreeningsEenheid> getActieveScreeningsEenhedenVoorScreeningOrganisatie(ScreeningOrganisatie sessionSO);
