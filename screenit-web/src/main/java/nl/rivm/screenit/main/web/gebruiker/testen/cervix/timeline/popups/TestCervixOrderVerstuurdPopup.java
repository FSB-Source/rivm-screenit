...
public class TestCervixOrderVerstuurdPopup extends TestCervixUitnodigingenPopup
{

	private static final long serialVersionUID = 1L;

	public TestCervixOrderVerstuurdPopup(String id, IModel<List<Client>> clientModel)
	{
	...
	{
		return testTimelineService.magOrderVerstuurd(uitnodiging);
	}
