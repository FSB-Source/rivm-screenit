...
public class MammaAfspraakBetreftFragment extends DocumentTemplateTestenFieldsPanelComponentFragment<String>
{

	private static final String MARKUP_ID = "fragmentMammaAfspraakBetreft";

	@SpringBean
	private SimplePreferenceService preferenceService;

	public MammaAfspraakBetreftFragment(final String id,
