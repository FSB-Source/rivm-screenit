...
public interface VragenlijstDao
{
	...
	boolean isVragenlijstGekoppeldAanHolder(Long vragenlijstId, Class<? extends VragenlijstAntwoordenHolder> holderType);

	List<ProjectBrief> getAllProjectBrievenWithFormulier(ScreenitFormulierInstantie oldFormulierInstantie);
