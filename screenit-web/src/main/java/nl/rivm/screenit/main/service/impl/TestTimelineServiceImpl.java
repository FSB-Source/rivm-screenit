...
public class TestTimelineServiceImpl implements TestTimelineService
{

	public static final int DEFAULT_TIIJD_TUSSEN_VERSTUURD_EN_UITSLAG_ONTVANGEN = 8;

	private static final Logger LOG = LoggerFactory.getLogger(TestTimelineServiceImpl.class);
