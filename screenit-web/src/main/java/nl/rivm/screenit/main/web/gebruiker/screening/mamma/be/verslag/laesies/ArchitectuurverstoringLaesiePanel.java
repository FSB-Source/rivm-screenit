...
public class ArchitectuurverstoringLaesiePanel extends LaesiePanel
{
	public ArchitectuurverstoringLaesiePanel(String id, IModel<LaesieDto> model, List<LaesieDto> alleLaesies)
	{
