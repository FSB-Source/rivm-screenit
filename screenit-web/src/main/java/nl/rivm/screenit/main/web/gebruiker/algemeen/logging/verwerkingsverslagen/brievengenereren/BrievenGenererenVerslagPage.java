...
@SecurityConstraint(
	...
	recht = Recht.GEBRUIKER_BRIEVEN_VERWERKING_VERSLAG,
	bevolkingsonderzoekScopes = { Bevolkingsonderzoek.COLON, Bevolkingsonderzoek.CERVIX, Bevolkingsonderzoek.MAMMA })
public class BrievenGenererenVerslagPage extends AlgemeenPage
{

	private static final long serialVersionUID = 1L;

	public BrievenGenererenVerslagPage(IModel<BrievenGenererenRapportage> model)
	{
		add(new BrievenGenererenVerslagPanel("panel", model));
	}
