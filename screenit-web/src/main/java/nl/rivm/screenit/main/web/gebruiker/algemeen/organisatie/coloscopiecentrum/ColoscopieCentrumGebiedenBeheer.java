...
public class ColoscopieCentrumGebiedenBeheer extends OrganisatieBeheer
{
	...
	public ColoscopieCentrumGebiedenBeheer()
	{
		...
		zoekObject.setColoscopieCentrum((ColoscopieCentrum) organisatie);
