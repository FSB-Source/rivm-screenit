...
@SecurityConstraint(
	...
	recht = Recht.GEBRUIKER_IFOBT_VERWERKING_VERSLAG,
	bevolkingsonderzoekScopes = { Bevolkingsonderzoek.COLON })
public class IfobtVerwerkingVerslagPage extends AlgemeenPage
{

	private static final long serialVersionUID = 1L;

	public IfobtVerwerkingVerslagPage(IModel<IfobtVerwerkingBeeindigdLogEvent> model, LogGebeurtenis logGebeurtenis)
	{
		add(new IfobtVerwerkingVerslagPanel("panel", model, logGebeurtenis));
	}
