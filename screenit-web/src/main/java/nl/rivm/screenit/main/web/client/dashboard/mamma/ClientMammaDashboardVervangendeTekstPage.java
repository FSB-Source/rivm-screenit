...
public class ClientMammaDashboardVervangendeTekstPage extends ClientBaseDashboardVervangendeTekstPage
{
	private static final long serialVersionUID = 1L;

	public ClientMammaDashboardVervangendeTekstPage()
	{
		super(Bevolkingsonderzoek.MAMMA);
	}
