...
public interface OvereenkomstService
{
	...
	Overeenkomst saveOrUpdateOvereenkomst(OvereenkomstDto overeenkomstDto);

	Overeenkomst geefLaatsteOvereenkomst();

	OvereenkomstDto convertOvereenkomstToDto(Overeenkomst overeenkomst);
