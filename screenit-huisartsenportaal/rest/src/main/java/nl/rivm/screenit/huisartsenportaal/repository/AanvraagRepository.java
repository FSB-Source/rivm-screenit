...
public interface AanvraagRepository extends BaseRepository<LabformulierAanvraag>
{

	List<LabformulierAanvraag> findByLocatieAndStatus(Locatie locatie, AanvraagStatus status);
}
