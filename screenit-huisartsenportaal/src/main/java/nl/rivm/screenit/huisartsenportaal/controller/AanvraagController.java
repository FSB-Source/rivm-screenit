...
@RestController
@RequestMapping("/api/v1/aanvragen")
...
public class AanvraagController extends BaseController
{
	...
	public ResponseEntity<AanvraagTotalenDto> getHuidigeAanvragen(@RequestBody TableResultOptionsDto tableResultOptionsDto, BindingResult result)
	{
		AanvraagTotalenDto aanvragen = labformulierService.getAanvragenHuisarts(getIngelogdeHuisarts(), tableResultOptionsDto);
		return new ResponseEntity<AanvraagTotalenDto>(aanvragen, HttpStatus.OK);
	}
