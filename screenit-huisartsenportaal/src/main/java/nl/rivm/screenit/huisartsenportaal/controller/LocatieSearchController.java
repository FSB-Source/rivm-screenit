...
@RestController
@RequestMapping("/api/v1/locaties")
...
public class LocatieSearchController extends BaseController
{
	...
	public ResponseEntity getLocaties(@Valid @RequestBody LocatieSearchDto searchDto, BindingResult result)
	{
		...
		if (arts != null)
		{
			LocatieResultDto dto = locatieService.getLocatieResultDto(arts, searchDto);
			return new ResponseEntity<LocatieResultDto>(dto, HttpStatus.OK);
		}
