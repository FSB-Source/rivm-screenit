...
public class CervixVervolgonderzoekReader extends BaseScrollableResultReader
{
	...
	public Criteria createCriteria(StatelessSession session) throws HibernateException
	{
		...
		crit.createAlias("ronde.uitstrijkjeCytologieUitslag", "uitstrijkje");
		crit.add(Restrictions.le("uitstrijkje.ontvangstdatum", dateSupplier.getDateTime().minusMonths(6).toDate()));
