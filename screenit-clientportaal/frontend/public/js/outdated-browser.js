...
outdatedBrowserRework({
    ...
    messages: {
        nl: {
            outOfDate: 'Helaas, het lukt niet om in te loggen in Mijn Bevolkingsonderzoek.',
            unsupported: 'Helaas, het lukt niet om in te loggen in Mijn Bevolkingsonderzoek.',
            update: {
                web: 'Dat komt omdat u een oudere webbrowser gebruikt. Een webbrowser is het programma dat u gebruikt voor internet.' +
                    '<br>' +
                    '<br>' +
                    'In Mijn Bevolkingsonderzoek bewaren we uw persoonlijke gegevens. Die moeten we goed kunnen beveiligen. Omdat oudere browsers minder veilig zijn, kunt u met uw browser niet inloggen op Mijn Bevolkingsonderzoek.' +
                    '<br>' +
                    '<br>' +
