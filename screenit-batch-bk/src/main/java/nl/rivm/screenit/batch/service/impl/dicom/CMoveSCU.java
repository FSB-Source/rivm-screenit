...
public class CMoveSCU extends Device
{
	...
	private void configureRemoteConnection(Connection conn, AAssociateRQ rq, SCPConfig qrSCPConfig)
	{
	...
	private void retrieve(Association as, Attributes searchKeys, SCPConfig storeSCPConfig) throws IOException, InterruptedException
	{
