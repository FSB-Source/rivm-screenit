...
public class MammaAdresGewijzigdMarkerResetWriter extends BaseWriter<GbaMutatie>
{
	...
	{
		gbaMutatie.setAanvullendeInformatie(gbaMutatie.getAanvullendeInformatie().replace(Constants.MAMMA_ADRES_GEWIJZIGD_MARKER, ""));
		hibernateService.saveOrUpdate(gbaMutatie);
	}
}
