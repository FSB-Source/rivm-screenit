package nl.rivm.screenit.batch.jobs.mamma.dense2.step;
...
@Slf4j
@Component
public class MammaDense2CsvExportTasklet implements Tasklet
{
	@Autowired
	...
	{
		var clienten = dense2Service.getExportClienten();
		chunkContext.getStepContext().getStepExecution().getJobExecution().getExecutionContext().putLong(MammaDense2Constants.AANTAL_CLIENTEN_IN_EXPORT, clienten.size());
