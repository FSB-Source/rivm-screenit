...
public class MammaPalgaImportVerslagenVerwijderenReader extends BaseScrollableResultReader
{
	...
	{
		Date verwijderDatum = DateUtil.toUtilDate(currentDateSupplier.getLocalDate().minusDays(preferenceService.getInteger(PreferenceKey.ILM_BEWAARTERMIJN_PALGA.name())));

		Criteria criteria = session.createCriteria(MammaFollowUpVerslag.class);
