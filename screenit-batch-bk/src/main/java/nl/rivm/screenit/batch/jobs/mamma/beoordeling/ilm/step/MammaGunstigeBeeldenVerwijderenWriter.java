...
public class MammaGunstigeBeeldenVerwijderenWriter extends MammaBeeldenVerwijderenWriter<MammaDossier>
{
    @Autowired
    ...
    {
        Criteria criteria = hibernateService.getHibernateSession().createCriteria(MammaScreeningRonde.class, "rondes");
        ...
        for (MammaScreeningRonde screeningRonde : rondes)
        {
