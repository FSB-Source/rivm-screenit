...
public class MammaUploadBeeldenStatusSignalerenReader extends BaseScrollableResultReader
{
	...
	public Criteria createCriteria(StatelessSession session) throws HibernateException
	{
		...
		Criteria criteria = session.createCriteria(MammaUploadBeeldenPoging.class);
