...
public interface IFobtHL7BerichtInlezenService
{
	List<ColonIFobtUitslagBericht> getAlleNietVerwerkteIFobtBerichten();

	void verwerkOntvangenIFobtBericht(ColonIFobtUitslagBericht bericht);
