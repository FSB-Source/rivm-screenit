...
@Component
public class ColonFITHerinneringJobListener extends BaseLogListener
{

	@Override
	protected void beforeStarting(JobExecution jobExecution)
	{
		jobExecution.getExecutionContext().putInt(ColonFITHerinneringJobConstants.HERINNERD, 0);
		jobExecution.getExecutionContext().putInt(ColonFITHerinneringJobConstants.GESELECTEERD, 0);
	}
	...
	protected LogEvent eindLogging(JobExecution jobExecution)
	{
		...
		herinneringLogEvent.setAantalGeselecteerd(context.getInt(ColonFITHerinneringJobConstants.GESELECTEERD));
		herinneringLogEvent.setAantalHerinnering(context.getInt(ColonFITHerinneringJobConstants.HERINNERD));
