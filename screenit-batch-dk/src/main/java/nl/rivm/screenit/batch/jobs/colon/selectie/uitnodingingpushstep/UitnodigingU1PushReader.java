...
@Component
public class UitnodigingU1PushReader extends AbstractUitnodigingPushReader
{

	@Autowired
	private ICurrentDateSupplier currentDateSupplier;

	public UitnodigingU1PushReader()
	{
		super(ColonUitnodigingCategorie.U1);
	}
	...
	public Criteria createCriteria(StatelessSession session) throws HibernateException
	{
		...
		crit.createAlias("dossier.colonVooraankondiging", "vooraankondiging", JoinType.LEFT_OUTER_JOIN);
		...
		crit.add(ColonRestrictions.getU1BaseCriteria(vandaag, null));
