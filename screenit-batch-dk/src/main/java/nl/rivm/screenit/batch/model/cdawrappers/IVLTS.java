...
public class IVLTS extends nl.rivm.screenit.hl7v3.cda.IVLTS
{
	...
	{
		return ivlts != null ? TS.value(ivlts.getLow()) : null;
	}

	public static Date highValue(nl.rivm.screenit.hl7v3.cda.IVLTS ivlts)
	{
		return ivlts != null ? TS.value(ivlts.getHigh()) : null;
	}
}
