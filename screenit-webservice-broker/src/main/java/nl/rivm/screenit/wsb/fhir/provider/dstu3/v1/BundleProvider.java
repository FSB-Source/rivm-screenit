...
public class BundleProvider extends BaseResourceProvider
{
	...
	public MethodOutcome create(@ResourceParam LabaanvraagBundle bundle)
	{
		...
		catch (Exception e)
		{
			...
			event.setMelding("Er is een onbekende fout opgetreden. Neem contact op met de helpdesk.");
	...
	private void doAanvraag(LabaanvraagBundle bundle)
	{
		CervixLabformulier labformulier = LabaanvraagMapper.INSTANCE.toLabformulier(bundle);
		labformulier.getUitstrijkje().setLabformulier(labformulier);
