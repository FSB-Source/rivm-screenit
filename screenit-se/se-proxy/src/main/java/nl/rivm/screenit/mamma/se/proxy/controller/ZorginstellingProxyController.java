...
public class ZorginstellingProxyController
{
	...
	public ResponseEntity<String> getZorginstellingenBK(HttpSession httpSession, @RequestHeader("YubikeyIdentificatie") String yubikeyIdentificatie)
	{
		...
		return proxyService.getRequest(RequestTypeCentraal.GET_ZORGINSTELLINGEN, CacheProxyActie.OPHALEN_ALS_NIET_GECACHT);
	}
}
