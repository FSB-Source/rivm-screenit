...
export type WijzigingenActions = WijzigingenVerwerktAction;

export const WIJZIGINGEN_VERWERKT = 'WIJZIGINGEN_VERWERKT';
export type WijzigingenVerwerktAction = { type: 'WIJZIGINGEN_VERWERKT' };
...
export type WijzigingenGemaaktAction = { type: 'WIJZIGINGEN_GEMAAKT' };
