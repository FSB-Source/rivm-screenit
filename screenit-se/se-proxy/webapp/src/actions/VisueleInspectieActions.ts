...
export type VisueleInspectieActions =
	MammografieOpslaanAction
...
export type MammografieOpslaanAction = {
...
export type MammografieWijzigenAction = {
...
export type CreateActionSetVisueleInspectieAfbeelding = {
	type: "SET_VISUELE_INSPECTIE_AFBEELDING";
	afspraakId: number;
	visueleInspectieAfbeeldingDto: AnnotatieAfbeeldingDto;
};
export const createActionSetVisueleInspectieAfbeelding = (afspraakId: number, visueleInspectieAfbeeldingDto: AnnotatieAfbeeldingDto): CreateActionSetVisueleInspectieAfbeelding => ({
	type: SET_VISUELE_INSPECTIE_AFBEELDING,
	afspraakId: afspraakId,
...
export type VulVisueleInspectieAfbeeldingenByAfspraakIdAction = {
	type: "VUL_VISUELE_INSPECTIE_AFBEELDINGEN_BY_AFSPRAAK_ID";
	visueleInspectieAfbeeldingen: Array<AnnotatieAfbeelding>;
};
...
export type DeleteVisueleInspectieAfbeeldingByAfspraakId = {
...
export type VulVisueleInspectieAfbeeldingByAfspraakIdAction = {
	type: "VUL_VISUELE_INSPECTIE_AFBEELDING_BY_AFSPRAAK_ID";
	afspraakId: number;
	visueleInspectieAfbeelding: AnnotatieAfbeelding;
};
export const createActionVulVisueleInspectieAfbeeldingByAfspraakId = (afspraakId: number, visueleInspectieAfbeelding: AnnotatieAfbeelding): VulVisueleInspectieAfbeeldingByAfspraakIdAction => ({
	type: VUL_VISUELE_INSPECTIE_AFBEELDING_BY_AFSPRAAK_ID,
	afspraakId: afspraakId,
...
export type MaakVisueleInsopectieIcoonAction = {
...
export const createActionMaakVisueleInspectieIcoon = (afspraakId: number, icoonType: AnnotatieIcoonType, x: number, y: number): MaakVisueleInsopectieIcoonAction => ({
	type: MAAK_VISUELE_INSPECTIE_ICOON,
	afspraakId: afspraakId,
...
export type SetVisueleInspectieIcoonPositionAction = {
...
export type SetVisueleInspectieIcoonTekstAction = {
...
export type VerwijderVisueleInspectieIcoonAction = {
