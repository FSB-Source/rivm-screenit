...
export const zelfdeTekst = (tekst: ?string, vergelijkTekst: ?string): boolean => {
    return (tekst === vergelijkTekst) || (nullOfLeeg(tekst) && nullOfLeeg(vergelijkTekst));
};

const nullOfLeeg = (tekst: ?string): boolean => {
