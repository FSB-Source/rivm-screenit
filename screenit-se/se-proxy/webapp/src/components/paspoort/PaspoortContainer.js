...
const mapStateToProps = (state: State, ownProps: PaspoortProps) => {
    ...
    if (tijdelijkAdres && ligtTussenData(vandaagISO(), tijdelijkAdres.startDatum, tijdelijkAdres.eindDatum)) {
        return {tijdelijkAdresValue: 'Er is een tijdelijk adres beschikbaar'};
    } else {
        return {tijdelijkAdresValue: 'Nee'};
    }
};

const mapDispatchToProps = dispatch => ({});

const PaspoortContainer = connect(mapStateToProps, mapDispatchToProps)(PaspoortView);
