...
public interface CervixBaseBetalingService
{
	...
	long totaalAantalHuisartsBoekRegelsInBetaalopdracht(CervixBetaalopdracht betaalopdracht, boolean debet);

	BigDecimal totaalBedragHuisartsBoekRegelsInBetaalopdracht(CervixBetaalopdracht betaalopdracht, boolean debet);

	BigDecimal totaalBedragLaboratoriumBoekRegelsInBetaalopdracht(CervixBetaalopdracht betaalopdracht);
