...
import nl.rivm.screenit.repository.colon.ColonIFobtBestandRepository;
import nl.rivm.screenit.repository.colon.ColonIFobtTestRepository;
...
import static nl.rivm.screenit.specification.colon.ColonIFobtTestSpecification.heeftActieveClient;
import static nl.rivm.screenit.specification.colon.ColonIFobtTestSpecification.heeftBarcode;
import static nl.rivm.screenit.specification.colon.ColonIFobtTestSpecification.heeftDossier;
import static nl.rivm.screenit.specification.colon.ColonIFobtTestSpecification.heeftFitType;
import static nl.rivm.screenit.specification.colon.ColonIFobtTestSpecification.isStatusDatumVoorOfOp;
import static nl.rivm.screenit.specification.colon.ColonIFobtTestSpecification.valideerFitUitslagStatus;
...
public class ColonBaseFitServiceImpl implements ColonBaseFitService
{
	...
	@Autowired
	private ColonIFobtTestRepository iFobtTestRepository;

	@Autowired
	private ColonIFobtBestandRepository iFobtBestandRepository;
	...
	{
		return iFobtTestRepository.findOne(heeftBarcode(barcode));
	}
	...
	public Optional<IFOBTTest> getLaatsteFitMetMissendeUitslagVanDossier(ColonDossier dossier, LocalDate signalerenVanaf, LocalDate minimaleSignaleringsDatum)
	{
		...
		return iFobtTestRepository.findFirst(specification, Sort.by(Sort.Direction.DESC, IFOBTTest_.ANALYSE_DATUM));
	}

	@Override
	public Optional<IFOBTBestand> getIfobtBestand(String bestandsnaam)
	{
		return iFobtBestandRepository.findOne(
