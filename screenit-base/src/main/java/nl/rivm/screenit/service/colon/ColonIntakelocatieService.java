...
public interface ColonIntakelocatieService
{
	Range<LocalDate> getSignaleringstermijnBereik();

	String getSignaleringstermijnTekst();

	boolean intakelocatieHeeftGeenCapaciteit(ColonIntakelocatie intakelocatie);
