...
public class InpakbareUitnodigingSpecification
{
	public static ExtendedSpecification<InpakbareUitnodiging<?>> heeftRetourzendingStatus(RetourzendingStatus status)
	{
		return (r, q, cb) -> cb.equal(r.get(InpakbareUitnodiging_.retourzendingStatus), status);
	}
