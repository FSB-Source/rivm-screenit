	...
	extends AbstractHibernateObject
{
	...
	@VraagElement(
		displayName = "Voorbereiding coloscopie",
		extraTekst = "Voorbereiding voor coloscopie door cli\u00ebnt",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140004",
		isReference = true)
	private MdlVoorbereidingColoscopie voorbereidingColoscopie;

	@Column
	@VraagElement(
		displayName = "Time-out procedure doorlopen",
		extraTekst = "Time-out procedure doorlopen ja/nee",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140028",
		isVerplicht = true)
	private Boolean timeoutProcedureDoorlopen;

	@OneToOne(fetch = FetchType.LAZY, mappedBy = "coloscopieMedischeObservatie", cascade = CascadeType.ALL)
	@VraagElement(displayName = "Medicatie", extraTekst = "Medicatie gegeven tijdens coloscopie", code = "2.16.840.1.113883.2.4.3.36.77.2.8.140089", isReference = true)
	private MdlMedicatie medicatie;

	@Column
	@VraagElement(displayName = "CO2 insufflatie", extraTekst = "Wel of geen CO2 insufflatie gebruikt", code = "2.16.840.1.113883.2.4.3.36.77.2.8.140022", isVerplicht = true)
	private Boolean co2Insufflatie;

	@Column
	@VraagElement(
		displayName = "Coecum / terminaal ileum intubatie",
		extraTekst = "Coecum / terminaal ileum bereikt (ja/nee)",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140040",
		isVerplicht = true)
	...
	@VraagElement(
		displayName = "Reden coecum niet bereikt",
		extraTekst = "Als het coecum niet is bereikt is, wat is de reden",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140041",
		isVerplicht = true)
	...
	@VraagElement(
		displayName = "Diepste punt insertie",
		extraTekst = "Als het coecum niet bereikt is, hoever er wel gekomen is (diepste punt insertie)",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140060",
		isVerplicht = true)
	...
	@VraagElement(displayName = "Afstand vanaf anus", extraTekst = "Afstand vanaf anus (in cm)", code = "2.16.840.1.113883.2.4.3.36.77.2.8.140065", isVerplicht = true, unit = {
	...
	@VraagElement(
		displayName = "Totale terugtrektijd",
		extraTekst = "Totale terugtrektijd in minuten. Ongecorrigeerd voor tijdelijke stops voor bijv. nemen van een biopt of poliepectomie",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140070",
		isVerplicht = true,
		unit = {
	...
	@Column
	@VraagElement(displayName = "Retroflexie rectum", extraTekst = "Retroflexie rectum", code = "2.16.840.1.113883.2.4.3.36.77.2.8.140105", isVerplicht = true)
	...
	@VraagElement(
		displayName = "Pati\u00ebntcomfort (GCS)",
		extraTekst = "Mate van pati\u00ebntcomfort, gecodeerd volgens Gloucester comfort score standaard",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140110",
		isVerplicht = true)
	...
	@VraagElement(
		displayName = "Reden afbreking coloscopie",
		extraTekst = "Als de coloscopie is afgebroken, wat is de reden dat het onderzoek incompleet is",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140120")
	private List<DSValue> redenAfbrekingColoscopie = new ArrayList<>();

	@Column(length = 4096)
	@VraagElement(displayName = "Text reden afbreking coloscopie", extraTekst = "", code = "2.16.840.1.113883.2.4.3.36.77.2.8.290185", isVerplicht = true)
	...
	@VraagElement(
		displayName = "Terugkoppeling cli\u00ebnt",
		extraTekst = "Directe terugkoppeling naar cli\u00ebnt na afloop van coloscopie",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140130")
	private DSValue terugkoppelingClient;

	@OneToOne(fetch = FetchType.LAZY, mappedBy = "coloscopieMedischeObservatie", cascade = CascadeType.ALL)
	@VraagElement(
		displayName = "Definitief vervolgbeleid voor bevolkingsonderzoek (groep)",
		extraTekst = "Definitief vervolgbeleid voor bevolkingsonderzoek (groep)",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140149",
		isReference = true)
	...
	@VraagElement(displayName = "Overige bevinding", extraTekst = "Bevinding die niet binnen screening past", code = "2.16.840.1.113883.2.4.3.36.77.2.8.145010")
	...
	@VraagElement(
		displayName = "Totaal aantal gedetecteerde laesies",
		extraTekst = "Het totaal aantal gedetecteerde laesies, omvat alle poliepen, ongeacht of deze zijn verwijderd, zijn geregistreerd of zijn ingezonden voor PA",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.145157",
		isVerplicht = true,
		unit = {
	...
	@VraagElement(
		displayName = "Aantal verwijderde laesies niet ingezonden voor PA en gegevens niet vastgelegd",
		extraTekst = "Totaal aantal verwijderde poliepen van het totaal aantal gedetecteerde poliepen, welke niet zijn vastgelegd en niet zijn ingezonden voor PA",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.145158",
		isVerplicht = true,
		unit = {
			@VraagElementUnit(unit = "aantal")
		})
	...
	@VraagElement(
		displayName = "Reden poliep(en) niet ingezonden voor pathologie",
		extraTekst = "Reden poliep(en) niet ingezonden voor pathologie",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.145159",
		isVerplicht = true)
	...
	@VraagElement(displayName = "Opdrachtnummer PA-lab", extraTekst = "Opdrachtnummer PA-lab", code = "2.16.840.1.113883.2.4.3.36.77.2.8.145161-group", isReference = true)
	private List<MdlOpdrachtnummerPalab> opdrachtnummerPalab = new ArrayList<>();

	@OneToMany(fetch = FetchType.LAZY, mappedBy = "coloscopieMedischeObservatie", cascade = CascadeType.ALL)
	@VraagElement(
		displayName = "T-nummer pathologie verslag",
		extraTekst = "T-nummer pathologie verslag",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.145162-group",
		isReference = true)
	...
	@VraagElement(
		displayName = "Eindconclusie",
		extraTekst = "Eindconclusie na interpretatie van eventueel PA verslag. Op basis van dit veld wordt vervolgbeleid voor deze pati\u00ebnt vastgesteld. Het gaat hier om vastlegging van de meest significante afwijking.",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140160",
		isVerplicht = true)
	...
	@VraagElement(
		displayName = "Vervolgbeleid n.a.v. afbreking coloscopie",
		extraTekst = "Vervolgbeleid n.a.v. afbreking coloscopie",
		code = "2.16.840.1.113883.2.4.3.36.77.2.2.140122",
		useInFormulier = false)
