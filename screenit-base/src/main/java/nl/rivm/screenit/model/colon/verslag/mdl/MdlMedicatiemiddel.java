	...
	extends AbstractHibernateObject
{
	...
	@VraagElement(
		displayName = "Medicatie tijdens coloscopie",
		extraTekst = "Medicatie gegevens tijdens coloscopie, middel ter sedatie of relaxerend. Dit concept bevat de naam van het middel.",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140090",
		isVerplicht = true)
	...
	@VraagElement(
		displayName = "Dosering medicatie",
		extraTekst = "Hoeveelheid medicatie die gegeven is tijdens de coloscopie",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.140100",
		isVerplicht = true,
		unit = {
