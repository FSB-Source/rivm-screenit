	...
	extends VerslagContent<CervixCytologieVerslag>
{
	...
	@OneToOne(fetch = FetchType.LAZY, mappedBy = "verslagContent", cascade = CascadeType.ALL)
	@VraagElement(displayName = "Cytologie uitslag BVO BMHK", extraTekst = "Cytologie uitslag BVO BMHK", code = "2.16.840.1.113883.2.4.3.36.77.2.8.270000", isReference = true)
	private CervixCytologieCytologieUitslagBvoBmhk cytologieUitslagBvoBmhk;

	@OneToOne(fetch = FetchType.LAZY, mappedBy = "verslagContent", cascade = CascadeType.ALL)
	@VraagElement(
		displayName = "Cytologie uitslag BVO BMHK tbv huisarts",
		extraTekst = "Cytologie uitslag BVO BMHK tbv huisarts",
		code = "2.16.840.1.113883.2.4.3.36.77.2.8.280000",
		isReference = true)
