...
public class PlanningScreeningsOrganisatieDto extends PlanningEntiteitDto
{
	public BigDecimal factorEersteOnderzoekBk;

	public BigDecimal factorDubbeleTijdBk;
