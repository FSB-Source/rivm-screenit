...
public interface MammaBaseBlokkadeDao
{
	...
	List<MammaBlokkade> getOverlappendeBlokkades(MammaBlokkade blokkade);

	List<MammaBlokkade> getActieveBlokkadesVoorSE(MammaStandplaats standplaats, MammaScreeningsEenheid se, Date dag);
