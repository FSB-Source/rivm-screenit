...
public abstract class ColonClientSelectieHelper
{
	...
	private static DetachedCriteria critEersteOngunstigeUitslagUitLaatsteRonde()
	{
		...
		critEersteOngunstigeUitslagUitLaatsteRonde.add(ScreenitRestrictions.colonOngunstig("testen"));
	...
	public static Criteria getQueryU3(Session session)
	{
		...
		ScreenitRestrictions.addNogGeenColonUitslagbriefOntvangenCriteria(crit, "laatsteScreeningRonde");
	...
	public static Criteria getBaseCriteria(Session session, UitnodigingsGebied uitnodigingsGebied, Integer minimaleLeeftijd, Integer maximaleLeeftijd, LocalDate peildatum)
	{
		...
		ScreenitRestrictions.addLeeftijdsGrensRestrictions(crit, minimaleLeeftijd, maximaleLeeftijd, peildatum);
	...
	{
		ColonClientSelectieHelper.currentDateSupplier = currentDateSupplier;
	}
