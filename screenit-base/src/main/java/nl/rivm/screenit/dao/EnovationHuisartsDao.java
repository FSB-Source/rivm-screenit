...
public interface EnovationHuisartsDao
{
	...
	long telHuisartsen(EnovationHuisarts zoekObject);

	void verwijderdeHuisartsenOntkoppelen();

	EnovationHuisarts getHuisartsByAgb(String agbCode);

	List<String> getKlantnummersVanAlleActiveHuisartens();

	void verwijderHuisartsen(List<String> activeKlantnummers);
}
