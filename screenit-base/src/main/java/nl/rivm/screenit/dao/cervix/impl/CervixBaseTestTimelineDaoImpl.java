...
public class CervixBaseTestTimelineDaoImpl extends AbstractAutowiredDao implements CervixBaseTestTimelineDao
{

	@Override
	public List<CervixHuisartsLocatie> getFirstCervixHuisartsLocatie()
	{
		Criteria crit = getSession().createCriteria(CervixHuisartsLocatie.class);
		crit.createAlias("huisarts", "huisarts");
