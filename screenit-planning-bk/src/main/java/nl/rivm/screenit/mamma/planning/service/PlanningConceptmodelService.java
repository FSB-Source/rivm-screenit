...
public interface PlanningConceptmodelService
{
	void resetConceptmodel();

	void annuleerConceptmodelWijzigingen(PlanningScreeningsOrganisatie screeningsOrganisatie);
