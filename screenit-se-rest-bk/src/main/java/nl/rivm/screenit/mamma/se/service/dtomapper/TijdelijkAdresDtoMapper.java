...
public class TijdelijkAdresDtoMapper
{
	public TijdelijkAdres updateTijdelijkAdres(TijdelijkAdres tijdelijkAdres, TijdelijkAdresSeDto tijdelijkAdresSeDto)
	{
		...
		tijdelijkAdres.setHuisletter(tijdelijkAdresSeDto.getHuisletter());
		tijdelijkAdres.setHuisnummerAanduiding(tijdelijkAdresSeDto.getHuisnummerAanduiding());
		tijdelijkAdres.setHuisnummerToevoeging(tijdelijkAdresSeDto.getHuisnummerToevoeging());
